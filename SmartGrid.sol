...
contract FederatedLearning {
    ...
    function setInitialWeights(int256[] memory weights) public {
        require(globalModelWeights.length == 0, "Global model already initialized");
    ...
    function updateGlobalModel() public {
        require(accounts.length > 0, "No participants to update the global model");
    ...
    function getLocalModel(address participant) public view returns (int256[] memory) {
